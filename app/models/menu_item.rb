class MenuItem < ActiveRecord::Base
  ...
  def span
  	menu_column_span = menu_section.menu_column.span.nil? ? 1 : menu_section.menu_column.span
  	menu_column_cols = menu_section.menu_column.cols.nil? ? 1 : menu_section.menu_column.cols
